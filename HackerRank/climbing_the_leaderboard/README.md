...
| **Difficulty** | 🟠 Medium |
| **Language** | Python 3.0 |
| **Category** | Algorithms → Implementation → Climbing the Leaderboard |
| **Source** | [HackerRank Problem ↗](https://www.hackerrank.com/challenges/climbing-the-leaderboard/problem) |
