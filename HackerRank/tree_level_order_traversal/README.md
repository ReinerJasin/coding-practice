...
| **Difficulty** | 🟢 Easy |
| **Language** | Python 3.0 |
| **Category** | Data Structures → Trees → Tree: Level Order Traversal |
| **Source** | [HackerRank Problem ↗](https://www.hackerrank.com/challenges/tree-level-order-traversal/problem) |
