...
| **Difficulty** | 🟢 Easy |
| **Language** | Python 3.0 |
| **Category** | Data Structures → Trees → Tree: Height of a Binary Tree |
| **Source** | [HackerRank Problem ↗](https://www.hackerrank.com/challenges/tree-height-of-a-binary-tree/problem) |
